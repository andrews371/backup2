...
def ano_dados(camp):
            ...
            try:
                ...
                if cont_jogos > 10 or dentro_rodada < 10:
                    ...
                    if rodada > 1: 
                        ...
                        if odd_pca <= 1.7:
                            total_ja += 1
                            if int(linha['FTHG']) != 1 or int(linha['FTAG']) != 0:
                                if rs > mrs:
                                    mrs = rs
                                rs = 0
                                taxa_n1x0 += 1
                            ...
                            total_ja += 1
                            if int(linha['FTHG']) != 0 or int(linha['FTAG']) != 1:
                                if rs > mrs:
                                    mrs = rs
                                rs = 0
                                taxa_n1x0 += 1
    ...
    return cont_geral - 1,taxa_n1x0,taxa_1x0,total_ja
...
for i in range(tam_ent2):
    try:
        num_jogos,taxa_n1x0,taxa_1x0,total_ja = ano_dados(entrada2[i])
